          ...
          <tbody>
            ...
            <tr>
              ...
              <td style={{ fontSize: "9px" }}>
                ...
                {(data?.fosterParentsCity || data?.fosterParentsState || data?.fosterParentsZip) && (
                  <span>
                    {" "}{data?.fosterParentsCity || ""},{" "}
                    {data?.fosterParentsState || ""}{" "}
                    {data?.fosterParentsZip || ""}
                  </span>
                )}
              </td>
            ...
            <tr>
              <td style={{ fontSize: "9px" }}>
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  ...
                  {data?.agencyPhone || "(805) 739-1111"}</span>
                  <span><strong>Date:</strong>{" "}
                  {formatDate(data?.signatureDate || data?.transactionDate) || ""}</span>
                </div>
              </td>
              <td></td>
              <td style={{ fontSize: "9px" }}>
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  <span><strong>Phone Number:</strong>{" "}
                  {data?.fosterParentsTelephone || ""}</span>
                  <span><strong>Date:</strong>{" "}
                  {formatDate(data?.signatureDate || data?.transactionDate) || ""}</span>
                </div>
              </td>
